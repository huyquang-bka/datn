...
class Ui_Layout_Search(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.txt_plate.setObjectName("txt_brand")
        self.gridLayout_2.addWidget(self.txt_plate, 1, 1, 1, 1)
        ...
        self.qlabel_plate.setObjectName("qlabel_brand")
        self.gridLayout_2.addWidget(self.qlabel_plate, 1, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.txt_brand, 0, 1, 1, 1)
        ...
        self.qlabel_brand.setObjectName("qlabel_plate")
        self.gridLayout_2.addWidget(self.qlabel_brand, 0, 0, 1, 1)
    ...
    def retranslateUi(self):
        ...
        self.qlabel_plate.setText(_translate("self", "Brand"))
        ...
        self.qlabel_brand.setText(_translate("self", "Plate"))
